    ...
    for homonym in homonyms:
        ...
        with open(filename, 'r', encoding='utf-8') as file:
            ...
            for annotated in annotated_data:
                ...
                annotated_same_context = annotated["same_context"]
                prediction_context = predicted["same_context"]
                if annotated_same_context:
...
if __name__ == '__main__':
   ...
   # results_file = 'bert_corpus.json'
    ...
    with open('elmo_corpus.json', 'r', encoding='utf-8') as file:
        corpus_entries = json.load(file)
        perform_evaluation(True, validated_corpus_location, corpus_entries, homonyms)